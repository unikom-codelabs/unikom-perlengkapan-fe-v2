...
const CetakBerkasNonRutinPage = () => {
  ...
  const renderAtkTahunanContent = () => (
    <>
      ...
      {renderTableSection(
        "Total Harga : Rp -",
        "Pengajuan ATK Non Rutin tahunan 2025",
      )}

      {renderTableSection(
        "Total Harga : Rp -",
        "Pengajuan ATK Lainnya Non Rutin tahunan 2025",
      )}
    </>
  );
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Pengajuan ATK Kelas Non Rutin 2025
            </p>
          </div>
          <div className="relative w-full md:w-80">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      <div className="mb-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Pengajuan ATK Ujian Non Rutin 2025
            </p>
          </div>
          <div className="relative w-full md:w-80">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
...
export default CetakBerkasNonRutinPage;
